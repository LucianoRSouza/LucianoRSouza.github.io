/* =========================================================
   Luciano Rodrigues — Portfolio JS (English Only, No i18n)
   ========================================================= */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  initStatModals();
  initMobileTimelineLogos();
  initTimelineMobileHeaders();
  ...
  console.log('✅ Portfolio JS (English only) initialized');
});
