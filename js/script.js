...
function enhanceProjectGalleries() {
  const map = {
  "blaupunkt-tools": ["./BP_Powertools.jpg","./Blaupunkt_Illumiation_booth_HK_Fair.png","./Blaupunkt_Power_Tools.png","./Blaupunkt_Tools.png"],
  "blaupunkt-power": ["./BP_Powertools.jpg","./Blaupunkt_Power_Tools.png","./Blaupunkt_Tools.png"],
