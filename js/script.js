 ...
 * =============================================================================
 * Modern ES6+ architecture with modular functions, comprehensive documentation,
 * and optimized performance. Maintains exact functionality while improving
 ...
 * Tracks current gallery images, active index, and selected language
 */
const PG_state = {
    images: [],      // Current gallery images array
    index: 0,        // Current slide index
    currentLang: 'en' // Active language code
};

/**
 * Map to store individual card slideshow states
 * Key: DOM Element (project card)
 * Value: Object containing slideshow state (images, index, timer, etc.)
 */
const CardSlides = new Map();

/**
 * Variable to save scroll position before opening modals
 * Used to restore position when closing modals
 */
 ...
 * Simplified wrappers for common DOM operations
 */
...
// =============================================================================
// SECTION 3: INTERNATIONALIZATION (I18N) SYSTEM
// =============================================================================

/**
 * Translation dictionary containing all UI text in 4 languages
 * Structure: language_code -> section -> key -> value
 */
window.I18N = {
    en: {
        nav: { 
        ...
        hero: {
            ...
            badges: { 
                top: 'Top Performer 2025', 
                middle: 'AI Specialist', 
                bottom: 'Trusted Leader' 
            },
            stats: {
        ...
        ibm: {
            apply: { 
                title: 'How I Apply This in Procurement:' 
            },
            genai: {
        ...
        umd: { 
            subtitle: 'AI and Career Empowerment', 
            desc: 'AI applications in business strategy and automation of procurement workflows.' 
        },
        mit: { 
            subtitle: 'Supply Chain Analytics', 
            desc: 'Advanced analytics methodologies for supply chain optimization and forecasting.' 
        },
        harvard: { 
            subtitle: 'Decision-Making in Leadership', 
            desc: 'Evidence-based decision frameworks and strategic thinking for leaders.' 
        },
        esl: {
    ...
    pt: {
        ...
        hero: {
            ...
            badges: { 
                top: 'Top Performer 2025', 
                middle: 'Especialista em IA', 
                bottom: 'Líder de Confiança' 
            },
            stats: {
        ...
        ibm: {
            apply: { 
                title: 'Aplicações em Procurement:' 
            },
            genai: {
        ...
        umd: { 
            subtitle: 'IA e Empoderamento de Carreira', 
            desc: 'Aplicações de IA em estratégia de negócios e automação de fluxos de procurement.' 
        },
        mit: { 
            subtitle: 'Supply Chain Analytics', 
            desc: 'Metodologias avançadas de analytics para otimização e forecasting da cadeia de suprimentos.' 
        },
        harvard: { 
            subtitle: 'Tomada de Decisão em Liderança', 
            desc: 'Frameworks de decisão baseados em evidências e pensamento estratégico para líderes.' 
        },
        esl: {
            school: 'Gadsden State Community College',
        ...
        github: {
            ...
            metrics: { 
                accuracy: 'Acurácia de Previsão', 
                cost: 'Redução de Custo', 
                stockout: 'Redução de Ruptura' 
            },
    ...
    es: {
        ...
        hero: {
            ...
            badges: { 
                top: 'Top Performer 2025', 
                middle: 'Especialista en IA', 
                bottom: 'Líder de Confianza' 
            },
            stats: {
        ...
        contact: {
            title: 'Conectemos',
            subtitle: '¿Listo para transformar tu estratégia de compras?',
            email: 'Email',
            location: 'Ubicación'
        }
    },
    ...
    fr: {
        ...
        hero: {
            ...
            badges: { 
                top: 'Top Performer 2025', 
                middle: 'Spécialiste IA', 
                bottom: 'Leader de Confiance' 
            },
            stats: {
...
// =============================================================================
// SECTION 4: DATA CONFIGURATION (Stats & Strategy Details)
// =============================================================================

/**
 * Returns stat detail data for modal content
 * Organized by stat key with multilingual support
 */
const getStatDetailsData = () => ({
    savings: {
        icon: "fa-piggy-bank",
        title: { 
            en: "Cumulative Savings Delivered", 
            pt: "Poupança Acumulada Entregue", 
            es: "Ahorros Acumulados Entregados", 
            fr: "Économies Cumulées Réalisées" 
        },
        value: "€1M+",
        details: {
            en: [
    ...
    rfps: {
        ...
        title: { 
            en: "Strategic Tenders Led", 
            pt: "Tenders Estratégicos Conduzidos", 
            es: "Licitaciones Estratégicas Dirigidas", 
            fr: "Appels d\'Offres Stratégiques Menés" 
        },
        value: "120+",
        details: {
            en: [
    ...
    projects: {
        ...
        title: { 
            en: "Project Portfolio Value", 
            pt: "Valor do Portfólio de Projetos", 
            es: "Valor del Portafolio de Proyectos", 
            fr: "Valeur du Portefeuille de Projets" 
        },
        value: "€10M+",
        details: {
            en: [
    ...
    regions: {
        icon: "fa-globe",
        title: { 
            en: "Global Operations Coverage", 
            pt: "Cobertura Operacional Global", 
            es: "Cobertura Operativa Global", 
            fr: "Couverture Opérationnelle Globale" 
        },
        value: "20+",
        details: {
            en: [
...
/**
 * Returns strategy detail data for modal content
 * Organized by strategy number with multilingual support
 */
const getStrategyDetailsData = () => ({
    1: {
        title: { 
            en: "Stand Design & Merchandising", 
            pt: "Design de Stand & Merchandising", 
            es: "Diseño de Stand & Merchandising", 
            fr: "Design de Stand & Merchandising" 
        },
        subtitle: { 
            en: "Creating immersive brand experiences", 
            pt: "Criando experiências de marca imersivas", 
            es: "Creando experiencias de marca inmersivas", 
            fr: "Création d'expériences de marque immersives" 
        },
    ...
    2: {
        title: { 
            en: "Meetings Orchestration & Lead Capture", 
            pt: "Reuniões & Captação de Leads", 
            es: "Orquestación de Reuniones & Captación", 
            fr: "Orquestration de Réunions & Capture" 
        },
        subtitle: { 
            en: "Maximizing ROI through structured engagement", 
            pt: "Maximizando ROI através de engajamento estruturado", 
            es: "Maximizando ROI mediante compromiso estructurado", 
            fr: "Maximisation du ROI via un engagement structuré" 
        },
    ...
    3: {
        title: { 
            en: "Negotiations & Partnering", 
            pt: "Negociações & Parcerias", 
            es: "Negociaciones y Alianzas", 
            fr: "Négociations et Partenariats" 
        },
        subtitle: { 
            en: "Building strategic supplier relationships", 
            pt: "Construindo relacionamentos estratégicos com fornecedores", 
            es: "Construyendo relaciones estratégicas con proveedores", 
            fr: "Construction de relations fournisseurs stratégiques" 
        },
    ...
    4: {
        title: { 
            en: "Tech Discovery & Benchmark", 
            pt: "Descoberta Tecnológica", 
            es: "Descubrimiento Tecnológico", 
            fr: "Veille Technologique & Benchmark" 
        },
        subtitle: { 
            en: "Staying ahead of market innovation", 
            pt: "Mantendo-se à frente da inovação de mercado", 
            es: "Manteniéndose a la vanguardia de la innovación de mercado", 
            fr: "Rester à la pointe de l'innovation marché" 
        },
        icon: "fa-microchip",
        sections: {
            en: [
    ...
    5: {
        title: { 
            en: "Factory Audits & Capability Mapping", 
            pt: "Auditorias de Fábrica", 
            es: "Auditorías y Mapeo de Capacidades", 
            fr: "Audits et Cartographie des Capacités" 
        },
        subtitle: { 
            en: "Ensuring operational excellence", 
            pt: "Garantindo excelência operacional", 
            es: "Garantizando excelencia operativa", 
            fr: "Assurance d'excellence opérationnelle" 
        },
        icon: "fa-industry",
        sections: {
            en: [
    ...
    6: {
        title: { 
            en: "Post-Fair Pipeline, ROI & Governance", 
            pt: "Pipeline, ROI & Governança", 
            es: "Pipeline Post-Feria, ROI y Gobernanza", 
            fr: "Pipeline Post-Salon, ROI et Gouvernance" 
        },
        subtitle: { 
            en: "Converting leads into revenue", 
            pt: "Convertendo leads em receita", 
            es: "Convirtiendo leads en ingresos", 
            fr: "Conversion des leads en revenus" 
        },
        icon: "fa-chart-line",
        sections: {
            en: [
...
// =============================================================================
// SECTION 5: MODAL FUNCTIONS
// =============================================================================

/**
 * Opens the stat detail modal with translated content
 * @param {string} key - Stat identifier (savings, rfps, projects, regions)
 */
function openStatModal(key) {
    ...
    $('#statModalDetails').innerHTML = (data.details[lang] || data.details.en)
        .map(it => `<li>${it}</li>`)
        .join('');
...
/**
 * Opens the strategy detail modal with translated content
 * @param {number} num - Strategy item number (1-6)
 */
...
/**
 * Closes the strategy detail modal
 */
...
// =============================================================================
// SECTION 6: GALLERY DOT ANIMATION
// =============================================================================

/**
 * Updates gallery dots for project cards
 * Applies active styling with scale and color transitions
 * @param {HTMLElement} card - Project card element
 * @param {number} idx - Active slide index
 */
...
// =============================================================================
// SECTION 7: PROJECT GALLERY MODAL NAVIGATION
// =============================================================================

/**
 * Changes the current slide in the project gallery modal
...
/**
 * Jumps to a specific slide in the project gallery modal
...
// =============================================================================
// SECTION 8: PROJECT CARD SLIDESHOW
// =============================================================================

/**
 * Sets up auto-sliding gallery for a project card
 * Handles hover pause, touch events, and click to open modal
 * @param {HTMLElement} card - Project card DOM element
 */
function setupCardAutoSlide(card) {
    ...
    /**
     * Advances to next slide with fade transition
     */
    function tick() {
...
/**
 * Opens the project gallery modal from a card click
 * Saves scroll position and builds slides
 * @param {HTMLElement} card - Project card element
 */
...
/**
 * Builds slide elements for the project gallery modal
...
// =============================================================================
// SECTION 9: PROJECT GALLERIES CONFIGURATION
// =============================================================================

/**
 * Configures project card galleries with image mappings
 * Centralized configuration for all project galleries
 */
function enhanceProjectGalleries() {
    /**
     * Image mappings for each gallery
     * Key: data-gallery attribute value
     * Value: Array of image paths
     */
    const map = {
        // Blaupunkt (Tools) - Todas as fotos com "Blaupunkt" no nome
        "blaupunkt": [
            "./Blaupunkt_Tools.png",
        ...
        // Blaupunkt Power Tools - Apenas fotos com "Power Tools" no nome
        "blaupunkt-power": [
            "./Blaupunkt_Power_Tools.png"
        ],
        // Blaupunkt Garden Tools - Apenas fotos com "Garden Tools" no nome
        "blaupunkt-garden": [
            "./Blaupunkt_Garden_Tools.png"
        ]
    };

    // Apply to each configured gallery
...
// =============================================================================
// SECTION 10: TRADE SHOW GALLERIES
// =============================================================================

/**
 * Trade show gallery image mappings
 */
...
/**
 * Opens trade show gallery for a specific brand
 * @param {string} brand - Brand key ('blaupunkt' or 'ford')
 */
...
/**
 * Initializes trade show duo cards from existing gallery content
 * Creates clickable brand cards that open the gallery modal
 */
function initTradeDuoFromExisting() {
    const sec = document.getElementById('trade-shows');
    if (!sec) return;
    
    // Get cover images from existing galleries
    ...
    duo.innerHTML = `
        <div class="brand-card" data-brand="blaupunkt">
            ...
            <div class="brand-body">
                <img src="${blauSrc}" alt="Blaupunkt cover"/>
            </div>
        </div>
        <div class="brand-card" data-brand="ford">
            ...
            <div class="brand-body">
                <img src="${fordSrc}" alt="Ford cover"/>
            </div>
        </div>
    `;
    ...
    // Add click handlers
    duo.querySelector('[data-brand="blaupunkt"]').addEventListener('click', () => openTradeGallery('blaupunkt'));
    duo.querySelector('[data-brand="ford"]').addEventListener('click', () => openTradeGallery('ford'));
}

// =============================================================================
// SECTION 11: MOBILE ENHANCEMENTS
// =============================================================================

/**
 * Initializes mobile-specific enhancements
 * Touch feedback, swipe gestures, and responsive behaviors
 */
function initMobileEnhancements() {
    ...
    // Swipe gesture for project card galleries
    $$('.project-card').forEach(card => {
        let startX = 0, currentX = 0;
        const gallery = card.querySelector('.gallery-main');
        if (!gallery) return;

        on(gallery, 'touchstart', e => { 
            startX = e.touches[0].clientX; 
        }, { passive: true });
        
        on(gallery, 'touchmove', e => { 
...
/**
 * Adds mobile timeline headers with company logos
...
/**
 * Adds mobile company logos to timeline items
 */
...
// =============================================================================
// SECTION 12: VOLUNTEER SECTION
// =============================================================================

/**
 * Initializes volunteer section enhancements
 * Adds hero image and fixes Gadsden logo
 */
...
/**
 * Fixes Gadsden logo images with fallback
 */
 ...
 * Adds scrolled class and manages scroll-to-top button
 */
...
/**
 * Opens lightbox with clicked image
 * @param {HTMLElement} el - Gallery item element
 */
...
/**
 * Closes lightbox and restores scroll
 */
...
// =============================================================================
// SECTION 15: TABS & TIMELINE
// =============================================================================

/**
 * Initializes trade show tabs
 */
...
/**
 * Initializes timeline spy for logo switching
 */
...
/**
 * Updates timeline spy based on scroll position
 * Changes company logo and highlights active item
 */
...
/**
 * Initializes i18n system with stored or browser language
 */
function initI18N() {
    try {
...
/**
 * Initializes smooth anchor scrolling
 */
...
// =============================================================================
// SECTION 19: STAT MODAL INITIALIZATION
// =============================================================================

/**
 * Initializes stat box click handlers
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Stored language
    try {
        const l = localStorage.getItem('lang') || document.documentElement.lang || 'en';
