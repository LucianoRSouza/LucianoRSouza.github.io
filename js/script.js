/* =========================================================
   Luciano Rodrigues — Portfolio JS (Google Translate Version)
   ========================================================= */
...
// Variável para salvar posição de scroll
...
/* -------------------------
   Dados — Stats (apenas em inglês, Google Translate cuidará do resto)
--------------------------*/
...
// Ir para slide específico no modal
